...
from pyengine.inference.yolo.d_struct.data_struct import YoloPose, YoloPoint, Yolo
from pyengine import load_build_dir


class YoloEngineWrapper:
    ...
    def get_result(self, item_index: int) -> Union[None, YoloPose, Yolo]:
        ...
        if self.yolo_pose:
            result_array = np.ctypeslib.as_array(result_ptr,
                                                 shape=(57,))  # lx, ly, rx, ry, conf, cls, pt1_x, pt1_y, pt1_conf, ...
